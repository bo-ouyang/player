<template>
  <div class="app-container">
        ...
        <el-col :span="12">
          <el-form-item prop="type" label="模式：">
            <el-radio-group v-model="queryForm.type">
              ...
              <el-radio v-for="type in 2" :key="type" :label="type">{{ type | investTypeName }}</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-table v-loading="isLoading" :data="orderList">
      <el-table-column label="提现地址" prop="origin_address" min-width="250px" />
      <el-table-column label="提现金额/ETH" min-width="110px">
