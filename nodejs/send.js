...
new Promise(function(resolve, reject) {
	...
	/*if (hashData) {
		console.log('last hash: ' + hashData.hash);
		return new Promise(function(resolve, reject) {
			let lastHash = hashData.hash;
			etherapi.gettxreceiptstatus(lastHash, function(res) {
				let status = false;
				if (!res) {
					console.log(res)
					status = false;
				...
				if (!status) {
					console.log('last hash is pending!');
					process.exit();
					return;
				} else {
					resolve(true);
